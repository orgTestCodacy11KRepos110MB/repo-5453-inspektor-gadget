...
func (op testOp) Params() params.ParamDescs {
	return nil
}

func (op testOp) PerGadgetParams() params.ParamDescs {
	return nil
}

func (op testOp) CanOperateOn(gadgets.Gadget) bool {
	return true
}
...
func (op testOp) Instantiate(Runner, any, *params.Params) (OperatorInstance, error) {
	return nil, nil
}
...
func createOp(name string, deps []string) operatorInterfaces {
	return operatorInterfaces{
		Operator: testOp{name, deps},
	}
}
